            ...
            <asp:UpdatePanel ID="updtPnlValidite" runat="server">
                <ContentTemplate>
                    ...
                    <fieldset>
                        ...
                        <asp:Panel runat="server" ID="pnlNomClient" CssClass="form-group">
                        ...
                        <asp:Panel runat="server" ID="pnlPrenomClient" CssClass="form-group">
                    ...
                    <fieldset>
                        ...
                        <asp:Panel runat="server" ID="pnlEmail" CssClass="form-group">
