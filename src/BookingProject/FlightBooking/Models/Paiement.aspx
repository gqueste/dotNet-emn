    ...
    <fieldset>
      <div class="form-group">
        <div class="col-sm-offset-3 col-sm-9">
            <asp:CheckBox CssClass="form-control" ID="cbInformationsValides" Text="J'atteste de la validité de ces informations" runat="server" OnCheckedChanged="cbInformationsValides_CheckedChanged"/>
        </div>
      </div>
      <div class="form-group">
        <div class="col-sm-offset-3 col-sm-9">
        ...
        <div class="col-sm-offset-3 col-sm-9">
            <asp:Button CssClass="btn btn-success" runat="server" ID="btnPayer" OnClick="btnPayer_Click" Text="Valider" Enabled="true"/>
        </div>
      </div>
    </fieldset>
  </form>
