<%@ Page Title="Nous contacter" Language="C#" MasterPageFile="~/FlightBooking.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="FlightBooking.Contact" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <h2>A propos / Nous contacter :</h2>
    <h4>Projet FlightBooking (réservations de vols et hôtels en ligne), réalisé par :</h4>
    <address>
        <table class="table">
            <tbody>
    ...
    <h4>Dans le cadre de l'enseignement "Programmation avec .Net" dispensé par monsieur F. Merand aux Mines de Nantes.</h4>
</asp:Content>
